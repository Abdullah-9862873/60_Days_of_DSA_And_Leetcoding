public class Video_30_Minimum_Insertion_Deletions_To_convert_string1_to_str2 {
    public static void main(String[] args) {
        ...
        // We have to delete the remaining items from the str1 i-e 'b' and 'd' in this case
        int deletions = str1.length() - longestCommonStuff;

        // We have to insert the remaining items from str2 into the remaining items after deletion in str1... So remaining items after deletion in str1 will be "ac" and we have to add 1 char into it i-e 'n' which is basically
