...
---> In java if you use a method defined in an class and that class whose method you are using is throwing an exception then you have to throw an exception too where you are using it... For Example clone method inside Object class is throwing an exception so when we are using it inside the Human class then we have to throw an exception there too....
*/