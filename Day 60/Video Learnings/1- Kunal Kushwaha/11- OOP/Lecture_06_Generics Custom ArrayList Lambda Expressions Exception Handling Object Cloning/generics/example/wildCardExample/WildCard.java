...
---> A Number class in java has all the classes related to numbers like Integer Float and all... 
...
Here you can only pass "Number" class but if we want to pass the subclasses of Number type i-e Integer and float etc. as parameter to this function also then we can use wildcard as:
