...
public class BoxWeight extends Box{
    ...
    BoxWeight(double l, double w, double h, double weight){
        ...
        // Used to access the weight variable from the parent class
        // super.weight;
    }
...
They both are not same... This is because in the first one, "this" gets replaced to "BoxWeight" which has the access to "l" "w" "h" and "weight"... But in the second one, since the ref variable is of type "Box" so it only has the access to "l" "w" and "h" so they are different... You cannot do something like (box5.weight)
