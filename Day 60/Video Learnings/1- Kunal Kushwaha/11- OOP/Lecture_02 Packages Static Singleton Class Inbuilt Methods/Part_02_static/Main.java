...
____________________________________________________________________
#### IMPORTANT ####
-----> Inside a static method, you cannot use anything that is not static... Because how can you put something that is dependent on the creation of objects inside something that is independent on the creation of objects... This is the reason that whatever functions we create in java, we make them static...
