...
6- UnBalanced Binary Tree: Unbalanced binary tree is when the height is greater than Log2(no of nodes) and the time complexity needed for the operations such as delete,add,find is more than O(log n). Abs(Height(left Tree) - Height(right Tree)) > 1
...
---------------------How To Solve!!!---------------------
----> We'll use self balancing binary tree or AVL...
