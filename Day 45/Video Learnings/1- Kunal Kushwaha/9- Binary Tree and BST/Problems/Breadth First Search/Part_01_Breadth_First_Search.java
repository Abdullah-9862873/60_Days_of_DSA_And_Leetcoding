...
----> When you are asked to search by level (order)

-----------------Example Question-----------------
----> Calculate the sum of nodes in binary search tree of each level
...
BFS will be like 1-2-3-4-5-6-7

-------If there is a Term LEVEL used then it is definately gonna use BFS-------
*/

import java.util.*;

public class Part_01_Breadth_First_Search {
