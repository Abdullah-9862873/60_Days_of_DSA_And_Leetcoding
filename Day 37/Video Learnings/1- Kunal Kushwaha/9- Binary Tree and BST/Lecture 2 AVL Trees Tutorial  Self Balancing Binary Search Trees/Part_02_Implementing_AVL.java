...
public class Part_02_Implementing_AVL{
    ...
    public static Node rotate(Node node){
        // Left Heavy Case
        // Here node is representing "p" and we are observing "c"
        if(height(node.left) - height(node.right) > 1){
            // It is left heavy... It will either be left-left or left-right
            // Now to determine whether it is left-left or left-right we have to observe the behavior of "g"
