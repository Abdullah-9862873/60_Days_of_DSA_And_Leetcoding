...
public class Video12_Minimum_Maximum_Falling_Path_Sum{
    ...
    public static int helperFunction(int[][] arr, int rowStart, int colStart) {
        ...
        for (int i = totalRowsRemaining; i >= 0; i--) {
            for (int j = arr[i].length - 1; j >= 0; j--) {
                ...
                // If I have encountered a place at the left diagonal side of the colStart that
                // I cannot visit then all the spaces at the left of that position cannot be
                // visited
