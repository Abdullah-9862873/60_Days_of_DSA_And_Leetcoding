...
/*
A slight performance improvement in this algorithm can be made if we use switch case rather than if else... In this optimized version, we use a switch statement to directly handle the cases of 0, 1, and 2 without redundant checks, which can potentially lead to some minor performance improvement.
